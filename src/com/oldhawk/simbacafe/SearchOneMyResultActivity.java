...
public class SearchOneMyResultActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_searchonemyresult);
	...
	private void initDateString(){
		...
		try{
			...
			fromDate = sdf.parse(intent.getStringExtra("mydate"));
	...
	public Handler msghandler=new Handler(){
 		public void handleMessage(Message msg){
    		...
    		myCls.AlertToast(message, Gravity.BOTTOM, Toast.LENGTH_LONG, SearchOneMyResultActivity.this);
    	}
   	};
	...
	public Handler handler=new Handler(){
		...
		public void handleMessage(Message msg){
    		...
    		System.out.println(bd.getString("cmd"));
 			if(bd.getString("cmd").toString().equalsIgnoreCase("q_myoneresult_list")){			
    ...
    private class resultListAdapter extends BaseAdapter {  
		...
		public View getView(int position, View convertView, ViewGroup parent) {
            ...
            String t=n.getAttributes().getNamedItem("itemname").getNodeValue();
            tdate.setText(t);
    ...
    class ListResultRunnable implements Runnable{  
    	...
    	public void run() {
			...
			hintmsg=getString(R.string.searchonemyresult_wait);
    		...
    		try{
    	    	...
    	    	URL url = new URL(myCls.getHttpServerUrl()+"/simba/public.php?method=getmyoneresult&from="+fd+"&login="+pubValue.GetLoginName());
    	    	...
    	    	if(conn.getResponseCode() == 200){
    	    		...
    	    		if(resultString.equals("NULL")){
    	    			...
    	    			bd.putString("cmd", "q_myoneresult_list");
    	    			message.setData(bd);
