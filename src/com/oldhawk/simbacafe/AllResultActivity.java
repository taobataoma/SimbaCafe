...
public class AllResultActivity extends Activity {
	...
	private void initDateString(){
		TextView dateTextView=(TextView)findViewById(R.id.allresult_status);
	...
	public Handler msghandler=new Handler(){
 		public void handleMessage(Message msg){
    		...
    		myCls.AlertToast(message, Gravity.BOTTOM, Toast.LENGTH_LONG, AllResultActivity.this);
    	}
   	};
	...
	public Handler handler=new Handler(){
		...
		public void handleMessage(Message msg){
    		...
    		System.out.println(bd.getString("cmd"));
 			if(bd.getString("cmd").toString().equalsIgnoreCase("q_allresult_list")){			
    ...
    private void initResultInfo(String xml){
		try{
	    	...
	    	for(int i=0;i<nsList.getLength();i++){
	    		...
	    		count=count+Integer.parseInt(n.getAttributes().getNamedItem("paysum").getNodeValue());
	    		adapter.arrNodes.add(n);
	    	}
	    	adapter.notifyDataSetChanged();
    		
	    	TextView tv=(TextView)findViewById(R.id.allresult_count);
	    	String t=getString(R.string.allresult_count);
    ...
    private class resultListAdapter extends BaseAdapter {  
		...
		public View getView(int position, View convertView, ViewGroup parent) {
            ...
            tdate.setText(t);
            t=n.getAttributes().getNamedItem("paysum").getNodeValue();
    ...
    class ListResultRunnable implements Runnable{  
    	...
    	public void run() {
			...
			hintmsg=getString(R.string.allresult_wait);
    		...
    		try{
    	    	...
    	    	URL url = new URL(myCls.getHttpServerUrl()+"/simba/public.php?method=getallresult&from="+fd+"&to="+td);
    	    	...
    	    	if(conn.getResponseCode() == 200){
    	    		...
    	    		if(resultString.equals("NULL")){
    	    			hintmsg=getString(R.string.allresult_null);
    	    			message = Message.obtain();
    	    			message.obj=hintmsg;
    	    			msghandler.sendMessage(message);
    	    		}else{
    	    			...
    	    			bd.putString("cmd", "q_allresult_list");
    	    			message.setData(bd);
